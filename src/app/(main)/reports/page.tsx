...
const Page = () => {
	...
	const [currentlySelectedRow, setCurrentlySelectedRow] = useState<null>(null);
						...
						>
							<button
								...
								onClick={async () => {
									...
									if (data.success) {
										setScanResults(prev => prev.filter(r => (r._id || r.id) !== id));
									} else {
    ...
    return (
        <>
            ...
            <div className="min-h-screen px-20 py-10 flex gap-20">
                <div className="w-2/3">
                    <DataTable columns={columnsWithHandler} data={scanResults} onRowClick={handleRowClick}/>
                </div>
                <div className="w-1/3">
